...
public partial class Detail : System.Web.UI.Page
{
    ...
    {
        string StrConn = WebConfigurationManager.ConnectionStrings["homeworkConnectionString"].ConnectionString;
    ...
    protected void Buttonadd_Click(object sender, EventArgs e)
    {
        ...
        if (FileUpload1.HasFile && Request.QueryString["date"] != null)
        {
            ...
            LabelUP.ForeColor = System.Drawing.Color.Green;
        }
        else
        {
            LabelUP.Text = "กรุณาอัพโหลดไฟล์ด้วย";
        }
    }
